...
function evaluateBoard(board: Cell[], cfg: LevelConfig): { solvable: boolean; matchDensity: number; avgScanDist: number } {
  ...
  var cellMatched: boolean[] = new Array(board.length).fill(false);
  var distSum = 0;
...
var LEVEL_1_TEMPLATES: number[][] = [
  [1, 1, 2, 2, 3, 3, 4, 4, 5, 2, 3, 4, 6, 6, 7, 7, 8, 8, 9, 9, 1, 1, 6, 7, 8, 9, 2],
  [2, 2, 3, 3, 4, 4, 5, 5, 6, 3, 4, 5, 7, 7, 8, 8, 9, 9, 1, 1, 2, 2, 7, 8, 9, 1, 3],
  [3, 3, 4, 4, 5, 5, 6, 6, 7, 4, 5, 6, 8, 8, 9, 9, 1, 1, 2, 2, 3, 3, 8, 9, 1, 2, 4],
  [4, 4, 5, 5, 6, 6, 7, 7, 8, 5, 6, 7, 9, 9, 1, 1, 2, 2, 3, 3, 4, 4, 9, 1, 2, 3, 5]
];
